...
new_sentence = [letter for letter in sentence if letter not in exclude]

print(''.join(new_sentence))

##################################
# Water Temperature
water_temp = [["0", "1.55", "8.33", "5.04", "26.5", "2015-08-01"],
...
print("Water Temperature in Celcius")
target_column = [row[4] for row in water_temp]
print(target_column)

print("Floating Number Form")
float_target = [float(row[4]) for row in water_temp]
print(float_target)

print("Celcius to Fahrenheit")
fahrenheit = [int((float(row[4]) * 1.8) + 32) for row in water_temp]
print(fahrenheit)
